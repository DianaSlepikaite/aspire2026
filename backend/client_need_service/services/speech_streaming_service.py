"""
Real-time speech streaming service using Azure Speech SDK.
"""
...
# Singleton instance for shared session state across WebSocket and HTTP
...
class SpeechStreamingService:
    ...
    def __init__(self) -> None:
        """Initialize the speech streaming service."""
    ...
    def _create_speech_config(self) -> Any:
        """Create Azure Speech configuration using application settings."""
        ...
        logger.info("Azure Speech streaming config initialized")
    ...
    async def create_session(
        ...
        Args:
            conversation_id: Optional conversation ID for transcript aggregation
    ...
    async def start_recognition(
        ...
        Args:
            ...
            loop: Event loop for scheduling async callbacks from sync SDK handlers
        """
        self._ensure_config()
        if (
    ...
    async def add_audio_chunk(self, session_id: str, audio_data: bytes) -> None:
        """
        Add audio chunk to the recognition stream.
